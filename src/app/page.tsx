...
export default function LandingPage() {
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        ...
        },
        {
          id: "m2",
          value: "Solar",
          description: "Powered Water Projects",
        },
        {
          id: "m3",
          value: "Computer",
          description: "Learning Hubs Established",
        },
      ]}
      ...
      products={[
        {
          ...
          name: "Solar Water Stations",
          price: "Commissioned",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/person-near-alternative-energy-plant_23-2149192714.jpg",
          reviewCount: "Operational",
        },
        {
          id: "p2",
          brand: "Education",
          name: "Computer Learning Centers",
          price: "Active",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/woman-looking-girl-answering-standing-near-desk_259150-60249.jpg",
          reviewCount: "Educating",
        },
        {
          id: "p3",
          brand: "Healthcare",
          name: "Facility Renovations",
          price: "Ongoing",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/people-volunteering-donating-facility_23-2148687311.jpg",
          reviewCount: "Healthier",
        },
      ]}
      ...
      testimonials={[
        {
          ...
          name: "Chief Okeke",
          handle: "@local-leader",
          testimonial: "The solar water project has completely transformed our daily lives. MCGI's commitment to our welfare is unmatched.",
          rating: 5,
        ...
        },
        {
          ...
          name: "Chinaza Obi",
          handle: "@student",
          testimonial: "The computer center opened doors for my studies that I never thought possible in my village.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/young-girl-eyeglasses-dreamily-looks-up-happy-tanned-teenager-striped-shirt-smiles-poses-orange-background_197531-27596.jpg",
        },
        {
          id: "t3",
          name: "Mrs. Nneka",
          handle: "@local-member",
          testimonial: "Seeing the renovation of our local health facility gives me hope for a healthier future for all our families.",
          rating: 5,
  ...
  <div id="faq" data-section="faq">
      ...
      faqs={[
        {
          id: "q1",
          title: "Who can join MCGI?",
          content: "MCGI welcomes all Mbaise indigenes at home and in the diaspora who share our commitment to positive growth.",
        },
        {
          id: "q2",
          title: "How can I support projects?",
          content: "You can support us through donations, volunteering your expertise, or joining our global network chapters.",
        },
        {
          id: "q3",
          title: "What is the Signature Centre Project?",
          content: "It is our landmark project to build a multifunctional hub for education, commerce, and innovation.",
        },
      ]}
      ...
      faqs={[
        {
          ...
          content: "Email: info@mcgi.org | Headquarters: Mbaise, Imo State.",
        },
      ]}
